...
import cn.zhaofd.demojpaweb.modules.demojpa.dto.SysInfo;
import cn.zhaofd.demojpaweb.modules.demojpa.dto.SysInfoStat;
...
public interface SysInfoRepository extends BaseRepository<SysInfo, Integer> {
     ...
     */
    @Query(value = """
            SELECT new cn.zhaofd.demojpaweb.modules.demojpa.dto.SysInfoStat(t.name, count(1)) FROM SysInfo t
            WHERE t.rcreatetime >= :startdate AND t.rcreatetime <= :enddate
            GROUP BY t.name
            """)
